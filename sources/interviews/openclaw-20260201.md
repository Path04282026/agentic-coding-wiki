It's just like having a new weird friend
...
basically do anything that you can do.
...
because it's it's a little bit of a new
category
...
can also like reply with some memes.
[snorts]
...
to take notes [music] live and clean
them up afterwards. That's why I love
Granola, the best AI meeting notes app
in the market. Here's how I use it.
Granola automatically takes [music]
notes during a meeting and I can add my
own notes too. After the meeting ends, I
use a Granola recipe to extract clear
takeaways and next [music] steps in the
exact format that I want. Then I can
just share notes directly in Slack with
my colleagues or even get Granola to
share her notes automatically. Honestly,
of all the AI apps that I use, Granola
is the one that saves me the most time.
Try it now at granola.ai/pater
and use the code Peter to sign up and
get three months free. That's
granola.ai/pater.
Now, back to our episode.
>> But, but dude, let's let's go back to
...
layers that make it complicated, right?
You
...
project is also it has a hackable
install
...
prompt request. Yeah,
>> it's enough to like understand the
intent
...
common messages.
Okay, that that looks good. It's
working.
...
anthropic API key?
>> It works with with any model.
>> Yeah.
>> Although you know they're in industry
like Anthropic and Open are kind of like
leading.
>> Yep.
>> It works with API keys. It works with
subscriptions.
>> Okay.
...
in space they say it's like oh can't do
that
...
for them on Tesco. Um or buying stuff on
Amazon.
...
in and I was like watching it and
sweating.
>> Wow.
>> Yeah. Wow.
...
from all those antibot systems because
it
...
and add it to your to your to-do list.
>> Yeah.
...
delete my computer
what are some uh safe things to start
with.
...
to help you to help you streamline
everything.
...
because I'm like way over my calorie
limit.
...
learn about you and it will update it
yourself.
...
it exactly knows all the quirks of the
website.
>> Yeah.
>> Because it did it before and it made
notes.
>> Got it. Yeah. Yeah. It's like teaching
someone to just learn something and they
can do it easily the ne the next time.
Yeah.
>> Yeah.
...
like the ultimate token burn machine.
>> Yeah.
...
Ralph." And I replied, "Yeah, it looks
Ralph."
...
you can get AI to run super long time.
It
...
then make you clarify stuff helps a lot.
Yeah,
...
make it manually compact or summarize
stuff?
...
of terminals like split screen.
>> Mhm.
...
just that I I'm like insanely more
productive.
...
partner from my my previous company.
Yeah.
...
>> You got to you got to explore. You're
like
>> Yeah.
...
>> Yeah. Uh cloud.bot. Uh it's also on
GitHub.
>> It's a cloud with a W. CL L A WD, right?
Yeah.
>> Yes. Yeah. Correct. [laughter]
>> Yeah.
